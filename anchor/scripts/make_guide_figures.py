...
for d, lab, c in [(nm, "MPtrj (base)", "#34495e"), (nu, "u200 (clean target)", "#2980b9"), (nk, "keep (compressed)", "#c0392b")]:
...
ax[0].set_title("The gate signal separates compressed from base\n(keep tail is 10⁴× higher)", fontweight="bold", fontsize=10)
